                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Unlock the perfect selling experience. Seamlessly list your property and let our expert team navigate you through a hassle-free selling journey.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Whether you're searching for a cozy apartment or a spacious villa, our rental service caters to your every need.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>From eye-catching visuals to compelling descriptions, we highlight your property's best features.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Explore secure and promising avenues with our legal investment services.From navigating regulations to assessing risks, our experts offer comprehensive advice for informed decisions.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>With a blend of expertise and integrity, we redefine your property journey, offering tailored solutions, and a wealth of opportunities.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p> We redefine excellence through tailored service, attention to detail, and a commitment to surpassing expectations.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Unlock the advantage of seasoned experts guiding your real estate endeavors.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Join the conversation, share experiences, and gain valuable insights to make informed real estate decisions. Together, let's navigate the complexities of the property market, empowering you to achieve your goals through collaborative discourse.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>From scrutinizing contracts to verifying property histories, our thorough file review process guarantees transparency and peace of mind.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We guide you through the process step-by-step, ensuring a smooth transition to owning your dream property.</p>
                        </div>
                    </div>
                </div>
            </div>
