										...
										<div class="row">
											<div class="col-md-5">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<br><br><br><select class="form-control" required name="isFeatured">
											...
											<input type="submit" position="center" value="Submit Property" class="btn btn-info"name="add" style="margin-left:200px;">
